...
#### Test 19: Zakończenie z dowolnego kroku (SUCCESS)

**Uwaga:** Endpoint `/complete` sam ustawi użytkownika na krok 5 i zakończy onboarding. Najpierw ustaw krok na 3:
...
Teraz możesz zakończyć onboarding z kroku 3:
...
```json
{
  "user_id": "00000000-0000-0000-0000-000000000000",
  "current_step": 5,
  "completed_at": "2025-10-12T10:15:00.000Z",
  "created_at": "2025-10-12T10:00:00.000Z",
  "preferences": {
    "id": "pref-uuid",
    "user_id": "00000000-0000-0000-0000-000000000000",
    ...
    "updated_at": "2025-10-12T10:15:00.000Z"
  }
}
```
...
# Krok 6: Zakończ onboarding z preferencjami
# Uwaga: endpoint /complete automatycznie ustawi current_step na 5
curl -X POST http://localhost:4321/api/onboarding/complete \
  -H "Content-Type: application/json" \
  -d '{
    "preferences": {
...
```bash
# Rozpocznij onboarding (dowolny krok)
curl -X PATCH http://localhost:4321/api/onboarding \
  -H "Content-Type: application/json" \
  -d '{"current_step": 1}'

# Zakończ onboarding (automatycznie przejdzie do kroku 5)
curl -X POST http://localhost:4321/api/onboarding/complete \
  -H "Content-Type: application/json" \
  -d '{
    "preferences": {
